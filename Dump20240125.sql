...
-- Dump completed on 2024-01-25 14:03:18
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: matchs-infos
-- ------------------------------------------------------
-- Server version	8.3.0
...
CREATE TABLE `arbitre` (
  ...
  `annee_de_naissance` int DEFAULT NULL,
...
CREATE TABLE `but` (
  ...
  `joueur_id` bigint DEFAULT NULL,
  `rencontre_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKd6avhm7js76uo2qkyvxvbjsha` (`joueur_id`),
  KEY `FKd861k2w4s9sc2ge5y7q5m1m7s` (`rencontre_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entraineur` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK2gk8dkiak80ampj0u954yusu2` (`equipe_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipe` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) DEFAULT NULL,
  `lieux_accueil_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKslw8rsaba9kmm11pfklsypffl` (`lieux_accueil_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `joueur` (
  ...
  `nom` varchar(255) DEFAULT NULL,
  `numero_de_maillot` int DEFAULT NULL,
  `poste` varchar(255) DEFAULT NULL,
  `prenom` varchar(255) DEFAULT NULL,
  `equipe_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKhrh0br197oaaly8dmduj07v3c` (`equipe_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `lieux_accueil`
--

DROP TABLE IF EXISTS `lieux_accueil`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lieux_accueil` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `adresse` varchar(255) DEFAULT NULL,
  `capacite` int DEFAULT NULL,
  `commentaires` varchar(255) DEFAULT NULL,
  `courriel` varchar(255) DEFAULT NULL,
  `infos_pmr` varchar(255) DEFAULT NULL,
  `nom` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `lieux_accueil`
--

LOCK TABLES `lieux_accueil` WRITE;
/*!40000 ALTER TABLE `lieux_accueil` DISABLE KEYS */;
/*!40000 ALTER TABLE `lieux_accueil` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `participation` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `time_entree` datetime DEFAULT NULL,
  `time_sortie` datetime DEFAULT NULL,
  `joueur_id` bigint DEFAULT NULL,
  `rencontre_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKbliayv9ttuo4hcmnpqw30lw9x` (`joueur_id`),
  KEY `FKpis7m4afi42sfd153r12lfhaw` (`rencontre_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `penalite` (
  ...
  `rencontre_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKr0du154rlomfsibcn8kufhh5p` (`rencontre_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rencontre` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `billet_url` varchar(255) DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  `equipe_domicile_id` bigint DEFAULT NULL,
  `equipe_exterieur_id` bigint DEFAULT NULL,
  `lieux_accueil_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKnbgoqor8iplfl2eelxi5v19de` (`equipe_domicile_id`),
  KEY `FKm1cc0dm0xcu0lmoxwvtlip19u` (`equipe_exterieur_id`),
  KEY `FKhf9qsxs25yn5jxjndhpuellix` (`lieux_accueil_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `rencontre_arbitre`
--
...
CREATE TABLE `rencontre_arbitre` (
  ...
  KEY `FK294nkgfom5kyiofpw6cfmcy20` (`arbitre_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rencontre_arbitre`
--

LOCK TABLES `rencontre_arbitre` WRITE;
...
-- Dump completed on 2024-01-25 14:03:20
