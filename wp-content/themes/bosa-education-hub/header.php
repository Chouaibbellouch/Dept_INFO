...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-education-hub' ); ?></a>
	...
	}elseif( get_theme_mod( 'header_layout', 'header_one' ) == 'header_fifteen' ) {
		get_template_part( 'template-parts/header/header', 'fifteen' );
	} ?>